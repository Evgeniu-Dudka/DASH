    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            toggleBtn.addEventListener("click", (function() {
                dropdownMenu.classList.toggle("sub-menu-open");
                toggleBtn.classList.toggle("arrow-open");
            }));
            document.addEventListener("click", (function(event) {
                if (!dropdownMenu.contains(event.target) && !toggleBtn.contains(event.target)) {
                    dropdownMenu.classList.remove("sub-menu-open");
                    toggleBtn.classList.remove("arrow-open");
                }
            }));
        }));
        window["FLS"] = true;
